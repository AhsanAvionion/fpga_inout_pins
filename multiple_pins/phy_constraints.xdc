...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {data_io_0[0]}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {data_io_0[1]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {data_io_0[2]}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {data_io_0[3]}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {data_io_0[4]}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {data_io_0[5]}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {data_io_0[6]}];  # "JA9"
set_property PACKAGE_PIN AA8  [get_ports {data_io_0[7]}];  # "JA10"
